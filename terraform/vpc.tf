...
# Create 2 Public Subnets (required for high availability across different availability zones)
...
# Create 2 Private Subnets for secure container execution
...
# Create an Internet Gateway (IGW) to allow public traffic
